...
function Coin(pos) {
  ...
  this.size = new Vector(1, 1);//0.6 0.6
...
Player.prototype.act = function(step, level, keys) {
  ...
  if (level.status == "lost") {
	...
	//this.size.x += step; - "Stretches image and repeats yoshi"
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  // Player loses
  if ((type == "lava" || type == "turtle" || type == "spikes" || type == "lspikes") && this.status == null) {
    this.status = "lost";
    this.finishDelay = 1.5;
  } else if (type == "coin") { //invis cube
